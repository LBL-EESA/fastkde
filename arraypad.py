...
#Downloaded from
#https://raw.github.com/numpy/numpy/v1.7.0/numpy/lib/arraypad.py on 10/11/2013
#at 11:00 AM.  This feature is unique to the numpy v >= 1.7 series, and it is
#the only >1.7 series feature necessary to get this code to work.  For backward
#compatibility with numpy 1.6, I have included this directly.
